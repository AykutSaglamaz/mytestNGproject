...
public class WebTables {
    ...
    public void entireTable(){
        ...
        driver.get(Day09_C6_ConfigReader.getProperty("app_qa_environment"));
        ...
        driver.findElement(By.id("UserName")).sendKeys(Day09_C6_ConfigReader.getProperty("manager_username"));
        driver.findElement(By.id("Password")).sendKeys(Day09_C6_ConfigReader.getProperty("manager_password"));
